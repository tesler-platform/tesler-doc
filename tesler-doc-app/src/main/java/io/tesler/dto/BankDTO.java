...
public class BankDTO extends DataResponseDTO {
	...
	public BankDTO(Bank bank) {
		...
		this.size = DictionaryType.COUNTRY.lookupValue(bank.getCountry());
		this.notes = bank.getNotes();
		this.country = DictionaryType.COUNTRY.lookupValue(bank.getCountry());
		...
		this.testDictionary = DictionaryType.DOC_TEST.lookupValue(bank.getTestDictionary());
		this.testRadio = DictionaryType.DOC_TEST.lookupValue(bank.getTestRadio());
	}
