...
public class ForceActiveExampleDTO extends DataResponseDTO {
	...
	@TDLov(DictionaryType.COUNTRY)
	private String country;

	@SearchParameter(provider = LovValueProvider.class)
	@TDLov(DictionaryType.LANGUAGE)
	private String language;

	public ForceActiveExampleDTO(ForceActiveExample entity) {
		this.id = entity.getId().toString();
		this.country = DictionaryType.COUNTRY.lookupValue(entity.getCountry());
		this.language = DictionaryType.LANGUAGE.lookupValue(entity.getLanguage());
	}
