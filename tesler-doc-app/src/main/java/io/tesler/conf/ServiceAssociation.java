...
public enum ServiceAssociation implements EnumBcIdentifier {
	...
	public static final EnumBcIdentifier.Holder<ServiceAssociation> Holder = new Holder<>(
			ServiceAssociation.class);
	...
	@Component
	public static class TESLERDOCBcSupplier extends AbstractEnumBcSupplier<ServiceAssociation> {
