...
@Service
public class ForAssocExService extends VersionAwareResponseService<ForAssocExDTO, ForAssocEx> implements
		ResponseService<ForAssocExDTO, ForAssocEx> {

	public ForAssocExService() {
