...
import io.tesler.entity.FileEntity;
...
@Service
public class BulkInsertExampleService
		extends VersionAwareResponseService<BulkInsertExampleDTO, BulkInsertExample>
		implements ResponseService<BulkInsertExampleDTO, BulkInsertExample> {

	@Autowired
	protected JpaDao jpaDao;

	public BulkInsertExampleService() {
