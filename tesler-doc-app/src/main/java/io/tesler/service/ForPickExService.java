...
@Service
public class ForPickExService extends VersionAwareResponseService<ForPickExDTO, ForPickEx> implements
		ResponseService<ForPickExDTO, ForPickEx> {

	public ForPickExService() {
