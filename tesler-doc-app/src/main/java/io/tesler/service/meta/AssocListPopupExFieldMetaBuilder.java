...
@Service
public class AssocListPopupExFieldMetaBuilder extends FieldMetaBuilder<AssocListPopupExDTO> {
	...
	@Override
	public void buildIndependentMeta(FieldsMeta<AssocListPopupExDTO> fields, InnerBcDescription bcDescription,
		Long parentId) {
