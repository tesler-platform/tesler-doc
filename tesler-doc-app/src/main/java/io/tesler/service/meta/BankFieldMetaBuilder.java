...
import io.tesler.conf.DictionaryType;
import io.tesler.core.dto.DrillDownType;
import io.tesler.core.dto.rowmeta.FieldsMeta;
import io.tesler.core.dto.rowmeta.RowDependentFieldsMeta;
import io.tesler.core.service.rowmeta.FieldMetaBuilder;
import io.tesler.conf.ServiceAssociation;
...
public class BankFieldMetaBuilder extends FieldMetaBuilder<BankDTO> {
	...
	public void buildRowDependentMeta(RowDependentFieldsMeta<BankDTO> fields,
		...
		fields.setDictionaryTypeWithAllValues(country, DictionaryType.COUNTRY);
		fields.setDictionaryTypeWithAllValues(testDictionary, DictionaryType.DOC_TEST);
		fields.setDictionaryTypeWithAllValues(testRadio, DictionaryType.DOC_TEST);
		fields.setDictionaryTypeWithAllValues(size, DictionaryType.SIZE);
		...
		if (innerBcDescription.getName().toLowerCase().equals("bankdoc")) {
			fields.setDrilldown(
					name,
					DrillDownType.INNER,
					"/screen/components/view/form/" + ServiceAssociation.bankDoc + "/" + rowId
			);
		} else {
			fields.setDrilldown(
					name,
					DrillDownType.INNER,
					"/screen/example/view/bankcard/" + ServiceAssociation.bank + "/" + rowId
			);
		}
	...
	public void buildIndependentMeta(FieldsMeta<BankDTO> fieldsMeta, InnerBcDescription innerBcDescription, Long aLong) {
		...
		fieldsMeta.setAllFilterValuesByLovType(country, DictionaryType.COUNTRY);
		fieldsMeta.setAllFilterValuesByLovType(size, DictionaryType.SIZE);
	}
