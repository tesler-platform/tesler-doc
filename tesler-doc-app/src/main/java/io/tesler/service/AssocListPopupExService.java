...
@Service
public class AssocListPopupExService extends VersionAwareResponseService<AssocListPopupExDTO, AssocListPopupEx> implements
		ResponseService<AssocListPopupExDTO, AssocListPopupEx> {

	public AssocListPopupExService() {
